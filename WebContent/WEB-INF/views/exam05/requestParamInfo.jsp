...
<div class="card m-2">
   ...
   <div class="card-body">
      <a href="ParamController?pageNo=5&kind=freeboard&writer=winter&hobby=movie&hobby=game" class="btn btn-warning btn-sm">GET 방식으로 전달</a>
      <hr />
      <form method="post" action="ParamController" novalidate>
         ...
         <button type="submit" class="btn btn-dark">POST 방식으로 전달</button>
      </form>
      ...
      <form method="post" enctype="multipart/form-data" action="FileUploadController">
      	  ...
      	  <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Enter Desc" id="desc" name="desc">
         </div>
	  	  <div class="form-group">
         ...
         <button type="submit" class="btn btn-primary">POST 방식/멀티파트로 전송</button>
	  </form>
